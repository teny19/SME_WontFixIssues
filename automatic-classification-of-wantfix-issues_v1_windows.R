...
dyn.load("C:\\Program Files\\Java\\jdk1.8.0_191\\jre\\bin\\server\\jvm.dll")
library(rJava)
library(JGR)
library(rpart)
library(bigmemory)
...
setwd("C:/Users/mitra/Documents/MM_A_Master_Degree_UZH/1_UZH_Msc_Course_Selection/1_Fall_2018_booking/BMINF005_Software Maintenance and Evolution/Group_Project/mm_practise")
#setwd("C:\\Users\\mitra\\Documents\\MM_A_Master_Degree_UZH\\1_UZH_Msc_Course_Selection\\1_Fall_2018_booking\\BMINF005_Software Maintenance and Evolution\\Group_Project\\mm_practise\\src_file")
getwd()
...
#path input
path_non_wontfix_issues_data<-"/src_file/projectsInfo-additional-wontfix-data-RQ3.csv"
#path_non_wontfix_issues_data<-"projectsInfo-additional-wontfix-data-RQ3.csv"

path_wontfix_issues_data<-"/src_file/projectsInfo-output_with_issue_urls-full-data-LABELED_categories_merged.csv"
#path_wontfix_issues_data<-"projectsInfo-output_with_issue_urls-full-data-LABELED_categories_merged.csv"
...
path_weka<-"C:/Program Files/Weka-3-8/weka"
...
#non_wontfix_issues_data$TitleIssue



half_wontfix_issues <- round(length(wontfix_issues_data$TitleIssue) / 2)
#print(length(wontfix_issues_data$TitleIssue))

half_non_wontfix_issues <- round(length(non_wontfix_issues_data$TitleIssue) / 2)
#print(half_wontfix_issues)


#setwd("C:\\Users\\mitra\\Documents\\MM_A_Master_Degree_UZH\\1_UZH_Msc_Course_Selection\\1_Fall_2018_booking\\BMINF005_Software Maintenance and Evolution\\Group_Project\\mm_practise\\temp_folder_baseline\\")
getwd()
td
#TRAINING SET 
i<-1
